...
from settings.network import load_proxy_settings, test_proxy_connection
from settings.credentials import load_api_key
...
def main():
    ...
    proxies.apply()
    os.environ["GEMINI_API_KEY"] = load_api_key("GEMINI")
